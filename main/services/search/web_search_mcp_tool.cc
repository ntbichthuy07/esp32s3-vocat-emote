...
void WebSearchMcpTool::Initialize() {
    ...
    mcp_server.AddTool(
        ...
        "media topics (Threads/TikTok/Facebook), or currently popular movies. For any VnExpress-"
        "specific request, use self.news.get_latest_vnexpress instead of this tool. Prefer reputable/"
