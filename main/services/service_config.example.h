...
// services/search/web_search_service.cc -- Tavily (https://tavily.com) search API. Sign up at
// tavily.com for a free-tier key (around 1000 searches/month).
constexpr const char* kTavilyApiKey = "CHANGE_ME";

// services/finance/finance_service.cc -- Google Apps Script Web App backing the personal finance
// ledger. Deploy services/finance/apps_script.gs as a Web App first -- see the setup steps at
